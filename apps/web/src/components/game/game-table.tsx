...
/**
 * M7 game-table shell. It renders authoritative projections and configurable
 * visual placeholders only; gameplay controls and final M8 art stay outside it.
 */
...
export function GameTable({ state, assetConfig }: GameTableProps) {
